...
func TestValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "アンダースコアは使えない", mutate: func(e *Event) { e.Device = "My_Laptop" }, wantErr: "underscore"},
		{name: "空白は使えない", mutate: func(e *Event) { e.Device = "My Laptop" }, wantErr: "whitespace"},
		{name: "パス区切りは使えない", mutate: func(e *Event) { e.Device = "My/Laptop" }, wantErr: "directory name"},
